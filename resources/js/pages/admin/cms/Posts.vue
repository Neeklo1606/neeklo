<template>
    <div class="posts-page">
        ...
        <div v-else-if="items.length === 0" class="text-center py-8 text-muted-foreground rounded-lg bg-card border border-border">Нет постов. <router-link to="/posts/create" class="text-primary hover:underline">Создать</router-link></div>
                    ...
                    <tbody class="divide-y divide-border">
                        <tr v-for="item in items" :key="item.id" class="hover:bg-muted/10">
                            ...
                            <td class="px-6 py-4 text-sm text-right">
                                <router-link :to="'/posts/' + item.id" class="px-3 py-1 text-xs bg-blue-500 hover:bg-blue-600 text-white rounded mr-2">Edit</router-link>
